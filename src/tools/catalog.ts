...
export const TOOL_CATALOG: CatalogGroup[] = [
  ...
  },
  {
    ...
    requiresConfig: false,
    tools: [
      { name: "todo_list", title: "Todo List", description: "Persistent todo list with add, update, remove, and clear actions" },
    ],
  },
  {
    id: "memory",
    ...
    requiresConfig: false,
    tools: [
      { name: "memory", title: "Memory Store", description: "Persistent key-value memory with get, set, delete, list, and search" },
    ],
  },
  {
    id: "mysql",
  ...
  },
  {
    ...
    requiresConfig: false,
    tools: [
      { name: "npm_info", title: "npm Package Info", description: "Look up version, description, dependencies, license, and downloads" },
      { name: "pypi_info", title: "PyPI Package Info", description: "Look up version, description, dependencies, license, and author" },
    ],
  },
  {
    id: "fetch",
    category: "web",
    label: "Fetch",
    description: "Fetch web pages and inspect HTTP headers",
    requiresConfig: false,
    tools: [
      { name: "web_fetch", title: "Web Fetch", description: "Fetch a webpage and extract clean readable text or raw HTML" },
      { name: "http_headers", title: "HTTP Headers", description: "Inspect HTTP response headers, redirects, and server info" },
    ],
  },
  {
    id: "perplexity",
